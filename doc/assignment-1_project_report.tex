...
1 node and 1 core               & tweetanalyzer\_1node\_1core.slurm   & 447.262 seconds                             \\
1 node and 8 cores              & tweetanalyzer\_1node\_8cores.slurm  & 59.062 seconds                               \\
2 nodes and 8 cores             & tweetanalyzer\_2nodes\_8cores.slurm & 65.907 seconds \\
\hline                             
\end{tabular}}
...
\addplot [blue!20!black,fill=blue!80!white]
	coordinates {
	(1 node 1 core,447.262)
	(1 node 8 cores,59.062)
	(2 nodes 8 cores,65.907)
};
\end{axis}
\end{tikzpicture}
\label{executiontime}
